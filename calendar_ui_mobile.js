...
function rcube_calendar_ui(settings)
{
    ...
    var event_edit_dialog = function(action, event)
    {
      ...
      $('#event_edit_save_button').click(function() {
        ...
        if ((data.attendees.length || (event.id && /* PAMELA */event.attendees && event.attendees.length)) && allow_invitations && (notify.checked || invite.checked || need_invitation)) {
      ...
      // PAMELA Mobile
        ...
        $("#event_edit_remove_button").hide();
        $("#event_edit_remove_button").unbind("click");       
        $("#event_edit_saveasnew_button").hide();
        $("#event_edit_saveasnew_button").unbind("click"); 
      }
    ...
    // PAMELA Mobile - Refresh skin mobile
    ...
    // PAMELA Mobile - Pas de header en skin mobile
