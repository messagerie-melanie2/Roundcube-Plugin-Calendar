...
class melanie2_mapping
{
    ...
    public static function rc_to_m2_status($status_rc)
    {
        $mapping = array(
            ...
            'busy' => LibMelanie\Api\Melanie2\Event::STATUS_CONFIRMED,
            'tentative' => LibMelanie\Api\Melanie2\Event::STATUS_TENTATIVE,
            'outofoffice' => LibMelanie\Api\Melanie2\Event::STATUS_CONFIRMED,
        );
    ...
    public static function m2_to_rc_status($status_m2)
    {
        $mapping = array(
            ...
            LibMelanie\Api\Melanie2\Event::STATUS_CONFIRMED => 'busy',
            LibMelanie\Api\Melanie2\Event::STATUS_TENTATIVE => 'tentative',
            LibMelanie\Api\Melanie2\Event::STATUS_CANCELLED => 'free',
            // pas géré en melanie2
    ...
    /**
     * Mapping de la classe (public, private, ...) RoundCube vers Mélanie2
    ...
    {
        $mapping = array(
            self::DEFAULT_VALUE => LibMelanie\Api\Melanie2\Event::CLASS_PUBLIC,
            'public' => LibMelanie\Api\Melanie2\Event::CLASS_PUBLIC,
            'private' => LibMelanie\Api\Melanie2\Event::CLASS_PRIVATE,
            'confidential' => LibMelanie\Api\Melanie2\Event::CLASS_CONFIDENTIAL,
        );
    ...
    /**
     * Mapping de la classe (public, private, ...) Mélanie2 vers RoundCube
    ...
    public static function m2_to_rc_class($class_m2) {
        $mapping = array(
            ...
            LibMelanie\Api\Melanie2\Event::CLASS_PUBLIC => 'public',
            LibMelanie\Api\Melanie2\Event::CLASS_PRIVATE => 'private',
            LibMelanie\Api\Melanie2\Event::CLASS_CONFIDENTIAL => 'confidential',
        );
    ...
    {
        $mapping = array(
            self::DEFAULT_VALUE => LibMelanie\Api\Melanie2\Attendee::ROLE_REQ_PARTICIPANT,
            'REQ-PARTICIPANT' => LibMelanie\Api\Melanie2\Attendee::ROLE_REQ_PARTICIPANT,
            'OPT-PARTICIPANT' => LibMelanie\Api\Melanie2\Attendee::ROLE_OPT_PARTICIPANT,
            'NON-PARTICIPANT' => LibMelanie\Api\Melanie2\Attendee::ROLE_NON_PARTICIPANT,
            'CHAIR' => LibMelanie\Api\Melanie2\Attendee::ROLE_CHAIR,
        );
    ...
    public static function m2_to_rc_attendee_role($attendee_role_m2)
    {
        $mapping = array(
            ...
            LibMelanie\Api\Melanie2\Attendee::ROLE_REQ_PARTICIPANT => 'REQ-PARTICIPANT',
            LibMelanie\Api\Melanie2\Attendee::ROLE_OPT_PARTICIPANT => 'OPT-PARTICIPANT',
            LibMelanie\Api\Melanie2\Attendee::ROLE_NON_PARTICIPANT => 'NON-PARTICIPANT',
            LibMelanie\Api\Melanie2\Attendee::ROLE_CHAIR => 'CHAIR',
        );
    ...
    {
        $mapping = array(
            self::DEFAULT_VALUE => LibMelanie\Api\Melanie2\Attendee::RESPONSE_NEED_ACTION,
            'NEEDS-ACTION' => LibMelanie\Api\Melanie2\Attendee::RESPONSE_NEED_ACTION,
            'ACCEPTED' => LibMelanie\Api\Melanie2\Attendee::RESPONSE_ACCEPTED,
            'DECLINED' => LibMelanie\Api\Melanie2\Attendee::RESPONSE_DECLINED,
            'TENTATIVE' => LibMelanie\Api\Melanie2\Attendee::RESPONSE_TENTATIVE,
            'UNKNOWN' => LibMelanie\Api\Melanie2\Attendee::RESPONSE_IN_PROCESS,
        );
    ...
    public static function m2_to_rc_attendee_status($attendee_status_m2)
    {
        $mapping = array(
            ...
            LibMelanie\Api\Melanie2\Attendee::RESPONSE_NEED_ACTION => 'NEEDS-ACTION',
            LibMelanie\Api\Melanie2\Attendee::RESPONSE_ACCEPTED => 'ACCEPTED',
            LibMelanie\Api\Melanie2\Attendee::RESPONSE_DECLINED => 'DECLINED',
            LibMelanie\Api\Melanie2\Attendee::RESPONSE_TENTATIVE => 'TENTATIVE',
            LibMelanie\Api\Melanie2\Attendee::RESPONSE_IN_PROCESS => 'UNKNOWN',
        );
    ...
    public static function valarm_ics_to_minutes_trigger($trigger)
    {
        ...
        $nbDay = 0; $nbHour = 0; $nbMin = 0; $nbWeeks = 0;
        if ($posW !== false)
        {
     ...
     *
     * @param LibMelanie\Api\Melanie2\Event $event  Melanie 2 Event
     *
     * @return array  An iCalendar 2.0 conform RRULE value for roundcube.
     */
    public static function m2_to_RRule20(LibMelanie\Api\Melanie2\Event $event)
    {
        ...
        if ($_recurrence->type !== LibMelanie\Api\Melanie2\Recurrence::RECURTYPE_NORECUR) {
            ...
            switch ($_recurrence->type) {
                case LibMelanie\Api\Melanie2\Recurrence::RECURTYPE_DAILY:
                ...
                case LibMelanie\Api\Melanie2\Recurrence::RECURTYPE_WEEKLY:
                ...
                case LibMelanie\Api\Melanie2\Recurrence::RECURTYPE_MONTHLY:
                ...
                case LibMelanie\Api\Melanie2\Recurrence::RECURTYPE_MONTHLY_BYDAY:
                    $start = new DateTime($event->start);
                ...
                case LibMelanie\Api\Melanie2\Recurrence::RECURTYPE_YEARLY:
                ...
                case LibMelanie\Api\Melanie2\Recurrence::RECURTYPE_YEARLY_BYDAY:
                    $start = new DateTime($event->start);
        ...
        if (isset($rdata[LibMelanie\Lib\ICS::FREQ])) {
            ...
            switch (strtoupper($rdata[LibMelanie\Lib\ICS::FREQ])) {
                case LibMelanie\Lib\ICS::FREQ_DAILY:
                    $recurrence->type = LibMelanie\Api\Melanie2\Recurrence::RECURTYPE_DAILY;
                    break;

                case LibMelanie\Lib\ICS::FREQ_WEEKLY:
                    $recurrence->type = LibMelanie\Api\Melanie2\Recurrence::RECURTYPE_WEEKLY;
                ...
                case LibMelanie\Lib\ICS::FREQ_MONTHLY:
                    if (isset($rdata[LibMelanie\Lib\ICS::BYDAY])) {
                        $recurrence->type = LibMelanie\Api\Melanie2\Recurrence::RECURTYPE_MONTHLY_BYDAY;
                        $recurrence->days = explode(',', $rdata[LibMelanie\Lib\ICS::BYDAY]);
                    } else {
                        $recurrence->type = LibMelanie\Api\Melanie2\Recurrence::RECURTYPE_MONTHLY;
                    }
                    break;

                case LibMelanie\Lib\ICS::FREQ_YEARLY:
                    if (isset($rdata[LibMelanie\Lib\ICS::BYYEARDAY])) {
                        $recurrence->type = LibMelanie\Api\Melanie2\Recurrence::RECURTYPE_YEARLY;
                    } elseif (isset($rdata[LibMelanie\Lib\ICS::BYDAY])) {
                        $recurrence->type = LibMelanie\Api\Melanie2\Recurrence::RECURTYPE_YEARLY_BYDAY;
                        $recurrence->days = explode(',', $rdata[LibMelanie\Lib\ICS::BYDAY]);
                    } else {
                        $recurrence->type = LibMelanie\Api\Melanie2\Recurrence::RECURTYPE_YEARLY;
                    }
            ...
            $recurrence->type = LibMelanie\Api\Melanie2\Recurrence::RECURTYPE_NORECUR;
        }
        return $recurrence;
    }
}