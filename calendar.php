  ...
  function preferences_save($p)
  {
    if ($p['section'] == 'calendar') {
      ...
      if (!$this->driver->nocategories) {
        ...
        // MANTIS 3597: Impossible de supprimer une catégorie
...
*/
  ...
  function export_events($terminate = true)
  {
    ...
    // PAMELA - Améliorer les performances de l'export en ne listant qu'un seul agenda
    $calendars = $this->driver->list_calendars(false, false, $calid);
    $events = array();
